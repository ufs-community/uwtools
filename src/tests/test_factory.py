from uwtools.factory import Factory
...
def test_factory():
	_ = Factory('Test0')
	try:
		from uwtools.factory import Test0Factory
	# linter will likely throw an error here since 'Test0Factory' is not a valid module until runtime
	except ModuleNotFoundError:
		raise AssertionError("'Test0Factory' was not found in the 'uwtools.factory' module")
