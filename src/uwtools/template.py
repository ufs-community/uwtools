...
class Template:
    ...
    """
        ...
        as a string (substitute_string) of in a complex dictionary (substitute_structure).
    ...
    substitutions = {
        ...
        TemplateConstants.AT_ANGLE_BRACKETS: TemplateConstants.SubPair(re.compile(r'@\<.*?\>+'), slice(2, -1))
    }
