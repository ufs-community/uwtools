"""
API access to the uwtools MPASInit driver.
"""
...
def execute(
    ...
    """
    obj = MPASInit(config_file=config_file, cycle=cycle, batch=batch, dry_run=dry_run)
    getattr(obj, task)()
    if graph_file:
