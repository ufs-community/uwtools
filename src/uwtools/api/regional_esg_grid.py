"""
API access to the uwtools ``regional_esg_grid`` driver.
"""
...
from uwtools.drivers.regional_esg_grid import RegionalEsgGrid as _RegionalEsgGrid
...
def execute(
    ...
    """
    Execute a ``regional_esg_grid`` task.
...
def tasks() -> Dict[str, str]:
    ...
    """
    return _support.tasks(_RegionalEsgGrid)
